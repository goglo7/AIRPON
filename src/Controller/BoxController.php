...
class BoxController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash("success", "Box ajouté avec succés");
    ...
    public function edit(Request $request, Box $box, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash("success", "Box modifié avec succés");
    ...
    {
        if ($this->isCsrfTokenValid('delete'.$box->getId(), $request->getPayload()->get('_token'))) {
            $entityManager->remove($box);
            $entityManager->flush();
        }

        $this->addFlash("success", "Box suprimé avec succés");
